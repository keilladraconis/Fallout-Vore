...
Function StoreCurrentWeight(Actor CurrentPred, Bool storeAtomicB, Bool storeCBBE)
	...
	If(storeAtomicB && data != NONE && data.Pred == CurrentPred && data.Pred.GetLeveledActorBase().GetSex()==1)
		data.StoredABSlim = BodyGen.GetMorph(data.Pred, true, sABSlim, NONE)
		data.StoredABBreast = BodyGen.GetMorph(data.Pred, true, sABBreast, NONE)
		data.StoredABBreastHuge = BodyGen.GetMorph(data.Pred, true, sABBreastHuge, NONE)
		data.StoredABThighSlim = BodyGen.GetMorph(data.Pred, true, sABThighSlim, NONE)
		data.StoredABNarrowWaist = BodyGen.GetMorph(data.Pred, true, sABNarrowWaist, NONE)
		data.StoredABButtHuge = BodyGen.GetMorph(data.Pred, true, sABButtHuge, NONE)
		data.StoredABBackWide = BodyGen.GetMorph(data.Pred, true, sABBackWide, NONE)
		data.StoredABBellySize = BodyGen.GetMorph(data.Pred, true, sABBellySize, NONE)
		data.StoredABButtFlat = BodyGen.GetMorph(data.Pred, true, sABButtFlat, NONE)
		data.StoredABButtStretch = BodyGen.GetMorph(data.Pred, true, sABButtStretch, NONE)
		data.StoredABButtWide = BodyGen.GetMorph(data.Pred, true, sABButtWide, NONE)
		data.StoredABHipsWide = BodyGen.GetMorph(data.Pred, true, sABHipsWide, NONE)
		data.StoredABTorsoLarge = BodyGen.GetMorph(data.Pred, true, sABTorsoLarge, NONE)
		data.StoredABWaistHeight = BodyGen.GetMorph(data.Pred, true, sABWaistHeight, NONE)
		data.StoredABWaistSmooth = BodyGen.GetMorph(data.Pred, true, sABWaistSmooth, NONE)
		data.StoredABWaistWide = BodyGen.GetMorph(data.Pred, true, sABWaistWide, NONE)
	...
	If(storeCBBE && data != NONE && data.Pred == CurrentPred && data.Pred.GetLeveledActorBase().GetSex()==1)
		data.StoredCBBE7BLower = BodyGen.GetMorph(data.Pred, true, sCBBE7BLower, NONE)
		data.StoredCBBE7BUpper = BodyGen.GetMorph(data.Pred, true, sCBBE7BUpper, NONE)
		data.StoredCBBEBreastsSmall = BodyGen.GetMorph(data.Pred, true, sCBBEBreastsSmall, NONE)
		data.StoredCBBEHips = BodyGen.GetMorph(data.Pred, true, sCBBEHips, NONE)
		data.StoredCBBECalf = BodyGen.GetMorph(data.Pred, true, sCBBECalf, NONE)
		data.StoredCBBEChubbyLegs = BodyGen.GetMorph(data.Pred, true, sCBBEChubbyLegs, NONE)
		data.StoredCBBEButtSmall = BodyGen.GetMorph(data.Pred, true, sCBBEButtSmall, NONE)
		data.StoredCBBESlimThighs = BodyGen.GetMorph(data.Pred, true, sCBBESlimThighs, NONE)
		data.StoredCBBEAppleCheeks = BodyGen.GetMorph(data.Pred, true, sCBBEAppleCheeks, NONE)
		data.StoredCBBEBigButt = BodyGen.GetMorph(data.Pred, true, sCBBEBigButt, NONE)
		data.StoredCBBEBreastWidth = BodyGen.GetMorph(data.Pred, true, sCBBEBreastWidth, NONE)
		data.StoredCBBEChestDepth = BodyGen.GetMorph(data.Pred, true, sCBBEChestDepth, NONE)
		data.StoredCBBEChubbyArms = BodyGen.GetMorph(data.Pred, true, sCBBEChubbyArms, NONE)
		data.StoredCBBEForearmSize = BodyGen.GetMorph(data.Pred, true, sCBBEForearmSize, NONE)
		data.StoredCBBEPushUp = BodyGen.GetMorph(data.Pred, true, sCBBEPushUp, NONE)
		data.StoredCBBEBreastPerkiness = BodyGen.GetMorph(data.Pred, true, sCBBEBreastPerkiness, NONE)
		data.StoredCBBEWaist = BodyGen.GetMorph(data.Pred, true, sCBBEWaist, NONE)
		data.StoredCBBESSBBW2 = BodyGen.GetMorph(data.Pred, true, sCBBESSBBW2, NONE)
		data.StoredCBBEGiantBelly = BodyGen.GetMorph(data.Pred, true, sCBBEGiantbelly, NONE)
		data.StoredCBBEBreasts = BodyGen.GetMorph(data.Pred, true, sCBBEBreasts, NONE)
		data.StoredCBBEBreastFantasy = BodyGen.GetMorph(data.Pred, true, sCBBEBreastFantasy, NONE)
		data.StoredCBBEUltKirBody = BodyGen.GetMorph(data.Pred, true, sCBBEUltKirBody, NONE)
...
Function SetNewWeight(WeightData data)	
	If(data != NONE)
		...
		If(SliderType == 1 && data.Pred.GetLeveledActorBase().GetSex()==1)
			BodyGen.SetMorph(data.Pred, true, sABSlim, NONE, data.CurrentABSlim)
			BodyGen.SetMorph(data.Pred, true, sABThighSlim, NONE, data.CurrentABThighSlim)
			BodyGen.SetMorph(data.Pred, true, sABBreast, NONE, data.CurrentABBreast)
			BodyGen.SetMorph(data.Pred, true, sABBreastHuge, NONE, data.CurrentABBreastHuge)
			BodyGen.Setmorph(data.Pred, true, sABNarrowWaist, NONE, data.CurrentABNarrowWaist)
			BodyGen.Setmorph(data.Pred, true, sABButtHuge, NONE, data.CurrentABButtHuge)
			BodyGen.SetMorph(data.Pred, true, sABBackWide, NONE, data.CurrentABBackWide)
			BodyGen.SetMorph(data.Pred, true, sABBellySize, NONE, data.CurrentABBellySize)
			BodyGen.SetMorph(data.Pred, true, sABButtFlat, NONE, data.CurrentABButtFlat)
			BodyGen.SetMorph(data.Pred, true, sABButtStretch, NONE, data.CurrentABButtStretch)
			BodyGen.SetMorph(data.Pred, true, sABButtWide, NONE, data.CurrentABButtWide)
			BodyGen.SetMorph(data.Pred, true, sABHipsWide, NONE, data.CurrentABHipsWide)
			BodyGen.SetMorph(data.Pred, true, sABTorsoLarge, NONE, data.CurrentABTorsoLarge)
			BodyGen.SetMorph(data.Pred, true, sABWaistHeight, NONE, data.CurrentABWaistHeight)
			BodyGen.SetMorph(data.Pred, true, sABWaistSmooth, NONE, data.CurrentABWaistSmooth)
			BodyGen.SetMorph(data.Pred, true, sABWaistWide, NONE, data.CurrentABWaistWide)
			BodyGen.UpdateMorphs(data.Pred)
		ElseIf(SliderType == 2 && data.Pred.GetLeveledActorBase().GetSex()==1)
			BodyGen.SetMorph(data.Pred, true, sCBBE7BLower, NONE, data.CurrentCBBE7BLower)
			BodyGen.SetMorph(data.Pred, true, sCBBE7BUpper, NONE, data.CurrentCBBE7BUpper)
			BodyGen.SetMorph(data.Pred, true, sCBBEBreastsSmall, NONE, data.CurrentCBBEBreastsSmall)
			BodyGen.SetMorph(data.Pred, true, sCBBEHips, NONE, data.CurrentCBBEHips)
			BodyGen.SetMorph(data.Pred, true, sCBBECalf, NONE, data.CurrentCBBECalf)
			BodyGen.SetMorph(data.Pred, true, sCBBEChubbyLegs, NONE, data.CurrentCBBEChubbyLegs)
			BodyGen.SetMorph(data.Pred, true, sCBBEButtSmall, NONE, data.CurrentCBBEButtSmall)
			BodyGen.SetMorph(data.Pred, true, sCBBESlimThighs, NONE, data.CurrentCBBESlimThighs)
			BodyGen.SetMorph(data.Pred, true, sCBBEAppleCheeks, NONE, data.CurrentCBBEAppleCheeks)
			BodyGen.SetMorph(data.Pred, true, sCBBEBigButt, NONE, data.CurrentCBBEBigButt)
			BodyGen.SetMorph(data.Pred, true, sCBBEBreastWidth, NONE, data.CurrentCBBEBreastWidth)
			BodyGen.SetMorph(data.Pred, true, sCBBEChestDepth, NONE, data.CurrentCBBEChestDepth)
			BodyGen.SetMorph(data.Pred, true, sCBBEChubbyArms, NONE, data.CurrentCBBEChubbyArms)
			BodyGen.SetMorph(data.Pred, true, sCBBEForearmSize, NONE, data.CurrentCBBEForearmSize)
			BodyGen.SetMorph(data.Pred, true, sCBBEPushUp, NONE, data.CurrentCBBEPushUp)
			BodyGen.SetMorph(data.Pred, true, sCBBEBreastPerkiness, NONE, data.CurrentCBBEBreastPerkiness)
			BodyGen.SetMorph(data.Pred, true, sCBBEWaist, NONE, data.CurrentCBBEWaist)
			BodyGen.SetMorph(data.Pred, true, sCBBESSBBW2, NONE, data.CurrentCBBESSBBW2)
...
Function RestoreWeight(WeightData data)	
	If(data != NONE)
		...
		If(data.AtomicBEnabled && data.Pred.GetLeveledActorBase().GetSex()==1)
			BodyGen.SetMorph(data.Pred, true, sABSlim, NONE, data.StoredABSlim)
			BodyGen.SetMorph(data.Pred, true, sABThighSlim, NONE, data.StoredABThighSlim)
			BodyGen.SetMorph(data.Pred, true, sABBreast, NONE, data.StoredABBreast)
			BodyGen.SetMorph(data.Pred, true, sABBreastHuge, NONE, data.StoredABBreastHuge)
			BodyGen.Setmorph(data.Pred, true, sABNarrowWaist, NONE, data.StoredABNarrowWaist)
			BodyGen.Setmorph(data.Pred, true, sABButtHuge, NONE, data.StoredABButtHuge)
			BodyGen.SetMorph(data.Pred, true, sABBackWide, NONE, data.StoredABBackWide)
			BodyGen.SetMorph(data.Pred, true, sABBellySize, NONE, data.StoredABBellySize)
			BodyGen.SetMorph(data.Pred, true, sABButtFlat, NONE, data.StoredABButtFlat)
			BodyGen.SetMorph(data.Pred, true, sABButtStretch, NONE, data.StoredABButtStretch)
			BodyGen.SetMorph(data.Pred, true, sABButtWide, NONE, data.StoredABButtWide)
			BodyGen.SetMorph(data.Pred, true, sABHipsWide, NONE, data.StoredABHipsWide)
			BodyGen.SetMorph(data.Pred, true, sABTorsoLarge, NONE, data.StoredABTorsoLarge)
			BodyGen.SetMorph(data.Pred, true, sABWaistHeight, NONE, data.StoredABWaistHeight)
			BodyGen.SetMorph(data.Pred, true, sABWaistSmooth, NONE, data.StoredABWaistSmooth)
			BodyGen.SetMorph(data.Pred, true, sABWaistWide, NONE, data.StoredABWaistWide)
			BodyGen.UpdateMorphs(data.Pred)
		EndIf
		If(data.CBBEEnabled && data.Pred.GetLeveledActorBase().GetSex()==1)
			BodyGen.SetMorph(data.Pred, true, sCBBE7BLower, NONE, data.StoredCBBE7BLower)
			BodyGen.SetMorph(data.Pred, true, sCBBE7BUpper, NONE, data.StoredCBBE7BUpper)
			BodyGen.SetMorph(data.Pred, true, sCBBEBreastsSmall, NONE, data.StoredCBBEBreastsSmall)
			BodyGen.SetMorph(data.Pred, true, sCBBEHips, NONE, data.StoredCBBEHips)
			BodyGen.SetMorph(data.Pred, true, sCBBECalf, NONE, data.StoredCBBECalf)
			BodyGen.SetMorph(data.Pred, true, sCBBEChubbyLegs, NONE, data.StoredCBBEChubbyLegs)
			BodyGen.SetMorph(data.Pred, true, sCBBEButtSmall, NONE, data.StoredCBBEButtSmall)
			BodyGen.SetMorph(data.Pred, true, sCBBESlimThighs, NONE, data.StoredCBBESlimThighs)
			BodyGen.SetMorph(data.Pred, true, sCBBEAppleCheeks, NONE, data.StoredCBBEAppleCheeks)
			BodyGen.SetMorph(data.Pred, true, sCBBEBigButt, NONE, data.StoredCBBEBigButt)
			BodyGen.SetMorph(data.Pred, true, sCBBEBreastWidth, NONE, data.StoredCBBEBreastWidth)
			BodyGen.SetMorph(data.Pred, true, sCBBEChestDepth, NONE, data.StoredCBBEChestDepth)
			BodyGen.SetMorph(data.Pred, true, sCBBEChubbyArms, NONE, data.StoredCBBEChubbyArms)
			BodyGen.SetMorph(data.Pred, true, sCBBEForearmSize, NONE, data.StoredCBBEForearmSize)
			BodyGen.SetMorph(data.Pred, true, sCBBEPushUp, NONE, data.StoredCBBEPushUp)
			BodyGen.SetMorph(data.Pred, true, sCBBEBreastPerkiness, NONE, data.StoredCBBEBreastPerkiness)
			BodyGen.SetMorph(data.Pred, true, sCBBEWaist, NONE, data.StoredCBBEWaist)
			BodyGen.SetMorph(data.Pred, true, sCBBESSBBW2, NONE, data.StoredCBBESSBBW2)
			BodyGen.SetMorph(data.Pred, true, sCBBEGiantBelly, NONE, data.StoredCBBEGiantBelly)
			BodyGen.SetMorph(data.Pred, true, sCBBEBreasts, NONE, data.StoredCBBEBreasts)
			BodyGen.SetMorph(data.Pred, true, sCBBEBreastFantasy, NONE, data.StoredCBBEBreastFantasy)
			BodyGen.SetMorph(data.Pred, true, sCBBEUltKirBody, NONE, data.StoredCBBEUltKirBody)
...
Float Function UpdateAtomicB(WeightData data, Float UpdateSlim)
	Float UpdateBreast = BodyGen.GetMorph(data.Pred, true, sABBreast, NONE)
	Float UpdateBreastHuge = BodyGen.GetMorph(data.Pred, true, sABBreastHuge, NONE)	
	Float TempSlim = BodyGen.GetMorph(data.Pred, true, sABSlim, NONE)
	Float UpdateThighSlim = BodyGen.GetMorph(data.Pred, true, sABThighSlim, NONE)
	Float UpdateNarrowWaist = BodyGen.GetMorph(data.Pred, true, sABNarrowWaist, NONE)
	Float UpdateButtHuge = BodyGen.GetMorph(data.Pred, true, sABButtHuge, NONE)
	
	Float UpdateABBackWide = BodyGen.GetMorph(data.Pred, true, sABBackWide, NONE)
	Float UpdateABBellySize = BodyGen.GetMorph(data.Pred, true, sABBellySize, NONE)
	Float UpdateABButtFlat = BodyGen.GetMorph(data.Pred, true, sABButtFlat, NONE)
	Float UpdateABButtStretch = BodyGen.GetMorph(data.Pred, true, sABButtStretch, NONE)
	Float UpdateABButtWide = BodyGen.GetMorph(data.Pred, true, sABButtWide, NONE)
	Float UpdateABHipsWide = BodyGen.GetMorph(data.Pred, true, sABHipsWide, NONE)
	Float UpdateABTorsoLarge = BodyGen.GetMorph(data.Pred, true, sABTorsoLarge, NONE)
	Float UpdateABWaistHeight = BodyGen.GetMorph(data.Pred, true, sABWaistHeight, NONE)
	Float UpdateABWaistSmooth = BodyGen.GetMorph(data.Pred, true, sABWaistSmooth, NONE)
	Float UpdateABWaistWide = BodyGen.GetMorph(data.Pred, true, sABWaistWide, NONE)
...
Float Function UpdateCBBE(WeightData data, Float UpdateSlim)
	Float Update7BUpper = BodyGen.GetMorph(data.Pred, true, sCBBE7BUpper, NONE)
	Float Update7BLower = BodyGen.GetMorph(data.Pred, true, sCBBE7BLower, NONE)
	Float UpdateCBBECalf = BodyGen.GetMorph(data.Pred, true, sCBBECalf, NONE)
	Float UpdateCBBEChubbyLegs = BodyGen.GetMorph(data.Pred, true, sCBBEChubbyLegs, NONE)
	Float UpdateCBBEHips = BodyGen.GetMorph(data.Pred, true, sCBBEHips, NONE)
	Float UpdateCBBEAppleCheeks = BodyGen.GetMorph(data.Pred, true, sCBBEAppleCheeks, NONE)
	Float UpdateCBBEBigButt = BodyGen.GetMorph(data.Pred, true, sCBBEBigButt, NONE)
	Float UpdateCBBEBreastWidth = BodyGen.GetMorph(data.Pred, true, sCBBEBreastWidth, NONE)
	Float UpdateCBBEChestDepth = BodyGen.GetMorph(data.Pred, true, sCBBEChestDepth, NONE)
	Float UpdateCBBEForearmSize = BodyGen.GetMorph(data.Pred, true, sCBBEForearmSize, NONE)
	Float UpdateCBBEButtSmall = BodyGen.GetMorph(data.Pred, true, sCBBEButtSmall, NONE)
	Float UpdateCBBESlimThighs = BodyGen.GetMorph(data.Pred, true, sCBBESlimThighs, NONE)
	Float UpdateCBBEPushUp = BodyGen.GetMorph(data.Pred, true, sCBBEPushUp, NONE)
	Float UpdateCBBEBreastPerkiness = BodyGen.GetMorph(data.Pred, true, sCBBEBreastPerkiness, NONE)
	Float UpdateCBBEWaist = BodyGen.GetMorph(data.Pred, true, sCBBEWaist, NONE)
	Float UpdateCBBEChubbyArms = BodyGen.GetMorph(data.Pred, true, sCBBEChubbyArms, NONE)
	Float UpdateCBBEBreastsSmall = BodyGen.GetMorph(data.Pred, true, sCBBEBreastsSmall, NONE)
	Float UpdateCBBESSBBW2 = BodyGen.GetMorph(data.Pred, true, sCBBESSBBW2, NONE)
	Float UpdateCBBEGiantBelly = BodyGen.GetMorph(data.Pred, true, sCBBEGiantbelly, NONE)
	Float UpdateCBBEBreasts = BodyGen.GetMorph(data.Pred, true, sCBBEBreasts, NONE)
	Float UpdateCBBEBreastFantasy = BodyGen.GetMorph(data.Pred, true, sCBBEBreastFantasy, NONE)
	Float UpdateCBBEUltKirBody = BodyGen.GetMorph(data.Pred, true, sCBBEUltKirBody, NONE)
