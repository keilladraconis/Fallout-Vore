Scriptname FalloutVore:FV_VoreRegenScript extends Quest
...
Event FalloutVore:FV_ConsumptionRegistryScript.OnDigest(FV_ConsumptionRegistryScript akSender, Var[] akArgs)			;akArgs[0] = CurrentPred, akArgs[1] = 0 - begin digestion 1 - end of digestion
